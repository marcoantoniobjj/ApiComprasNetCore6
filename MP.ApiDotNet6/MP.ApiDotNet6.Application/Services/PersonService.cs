...
namespace MP.ApiDotNet6.Application.Services
{
    public class PersonService : IPersonService
    {
        ...
        public async Task<ResultService<PersonDTO>> CreateAsync(PersonDTO personDTO)
        {
            ...
            var data = await _personRepository.CreateAsync(person); // aqui gera o ID que sera gravado na tabela
        ...
        //Implementar os metods que foram criados em IPersonService
        public async Task<ResultService<ICollection<PersonDTO>>> GetAsync() //metod para listar VARIAS pessoas
        {
        ...
        public async Task<ResultService<PersonDTO>> GetByIdAsync(int id) //metod para listar UMA pessoa
        {
            var person = await _personRepository.GetByIdAsync(id);
            if (person == null)
        ...
        public async Task<ResultService> UpdateAsync(PersonDTO personDTO)
        {
            ...
            if(!validation.IsValid)
                return ResultService.RequestError("Problerma com a validacao dos campos", validation);
